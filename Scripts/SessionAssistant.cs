...
public class SessionAssistant : MonoBehaviour {
    ...
    public void MovesFunction (int movess)
    {
    eat -= movess;
    energy -= movess;
    coffee -= movess;
    ...
    public void PlayNextLevel() {
        ...
        StartNavel.main.DiologLevel(LevelProfile.main.level+1);
    }
    */
    public void Win_fifti()
    {
    ...
    public void StartForLevel(int level) 
    {
    ...
    IEnumerator TargetSession(System.Func<bool> success, System.Func<bool> failed = null)
    {
        ...
        while (!outOfLimit && (score < score_target || !success.Invoke()) && (failed == null || !failed.Invoke()))
        {
            ...
            /*  игра выигрывается если заканчиваются ходы и получена хотя бы одна звезда
